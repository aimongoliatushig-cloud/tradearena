        ...
        <div className="glass-panel overflow-hidden">
          ...
          <div className="space-y-5 p-6 sm:p-8">
            <div className="flex flex-wrap items-center gap-3 text-xs uppercase tracking-[0.2em] text-white/40">
              <Link href={`/blog?category=${post.category.slug}`} className="rounded-full border border-white/10 bg-white/[0.04] px-3 py-1 text-[#95e8d5]">
                {post.category.name}
              </Link>
          ...
          {locked ? (
            <div className="mt-8 rounded-[1.75rem] border border-[#2dd0b1]/18 bg-[linear-gradient(180deg,rgba(24,199,162,0.12),rgba(255,255,255,0.02))] p-6">
              <div className="space-y-3">
                ...
                <h2 className="text-2xl font-semibold tracking-[-0.03em] text-white">Нийтлэлийн бүтэн хувилбарыг уншихын тулд нэвтэрнэ үү</h2>
                <p className="text-sm leading-7 text-white/62">
                  Энэ нийтлэлийн зөвхөн эхний 30%-ийг харуулж байна. Үнэгүй бүртгэл үүсгээд эсвэл нэвтэрч орж бүтэн агуулгыг уншаарай.
                </p>
              </div>
              <div className="mt-5 flex flex-wrap gap-3">
                <SignInButton mode="modal">
                  <button className="inline-flex h-11 items-center justify-center rounded-2xl bg-[linear-gradient(135deg,#39d3b3_0%,#18c7a2_58%,#10927c_100%)] px-5 text-sm font-semibold text-[#071210]">
                    Нэвтрэх
                  </button>
                </SignInButton>
                <SignUpButton mode="modal">
                  <button className="inline-flex h-11 items-center justify-center rounded-2xl border border-white/12 px-5 text-sm font-semibold text-white">
