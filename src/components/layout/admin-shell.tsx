...
import { BarChart3, BookOpenText, Boxes, DatabaseZap, GraduationCap, LayoutDashboard, ListChecks, LogOut, Settings, Users, Wrench } from "lucide-react";
...
const links = [
  ...
  { href: "/admin/packages", label: "Багцууд", icon: Boxes },
  { href: "/admin/enrollments", label: "Элсэлт", icon: Users },
  { href: "/admin/courses", label: "Сургалтууд", icon: GraduationCap },
  { href: "/admin/resources", label: "Нөөцүүд", icon: Wrench },
    ...
    <div className="grid min-h-screen lg:grid-cols-[280px_minmax(0,1fr)]">
      <aside className="border-r border-white/8 bg-[linear-gradient(180deg,rgba(12,16,22,0.96),rgba(15,21,28,0.92))] p-6 backdrop-blur-xl">
        <div>
          ...
          <div className="mt-2 text-xl font-semibold text-white">TradeArena Ops</div>
        ...
        <nav className="mt-8 space-y-2">
          {links.map((item) => (
            <Button key={item.href} variant="ghost" render={<Link href={item.href} />} className="w-full justify-start text-white/74 hover:text-white">
